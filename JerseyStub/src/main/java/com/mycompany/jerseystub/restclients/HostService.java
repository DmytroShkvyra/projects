...
public class HostService {
    ...
    public HostService() {
     ...
     public <T> T postCreateHosts(Class<T> responseType, String clusterName, String hostName) throws UniformInterfaceException {
        WebResource resource = webResource;
        resource = resource.path(java.text.MessageFormat.format("{0}/{1}/{2}", new Object[]{clusterName, "hosts", hostName}));
