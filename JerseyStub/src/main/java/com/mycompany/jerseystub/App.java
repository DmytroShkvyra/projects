...
public class App {
    ...
    public static void main(String[] args) throws ParserConfigurationException, SAXNotRecognizedException, SAXNotSupportedException, JSONException {
        ...
        agent = "{'componentStatus': [],'hostname': 'dshkvyra','nodeStatus': {'cause': 'NONE', 'status': 'HEALTHY'}, 'reports': [], 'responseId': 0, 'timestamp': "+System.currentTimeMillis()+"}";
        json = new JSONObject(agent);
        ...
        System.out.println("^ clusterName=" + clusterName + " serviceName=" + serviceName + " " + s);
        System.out.println("**********************Send heartbeat*********************");
        agent = "{'componentStatus': [],'hostname': 'dshkvyra','nodeStatus': {'cause': 'NONE', 'status': 'HEALTHY'}, 'reports': [], 'responseId': 1, 'timestamp': "+System.currentTimeMillis()+"}";
        json = new JSONObject(agent);
        response1 = agentResource.postHeartbeat(HeartBeatResponse.class, "dshkvyra", json);
        System.out.println(json + " " + response1);        
        System.out.println("----------------------------------------------------------");        
